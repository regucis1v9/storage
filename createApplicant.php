    ...
    public function createApplicant() {
        ...
        if ($this->hasNoEmptyKeys($personalData)) {
            ...
            if (filter_var($email, FILTER_VALIDATE_EMAIL)  && $emailResult->num_rows == 0) {
                $personSQL = "INSERT INTO `applicants`(`name`, `surname`, `email`, `city`, `job`, `birth_date`,`letter`) VALUES ('$name', '$surname', '$email', '$city', '$job', '$birthDate', '$letter')";
